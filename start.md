...
It's working fine that even if I added that code manually, because commands.c will be re-generated during `make` process. And a funny thing happened that my added line below `incrby` was moved to other place where was under `msetnx`, I was surprised but I didn't want to dig into at that time. (Of course this is due to auto-generate process)
